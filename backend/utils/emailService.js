...
class EmailService {
  ...
  async sendPasswordResetOTP({
    ...
    try {
      ...
      const mailOptions = {
        ...
        to: email,
        subject: "Reset Your Password - Educademy",
        html: emailContent,
      };
  ...
  async sendOTPVerification({
    ...
    try {
      const emailContent = emailTemplates.verification({
        userName: firstName,
        title: isRegistration ? "Verify Your Email" : "Email Verification",
        subtitle: isRegistration
          ? "Welcome to Educademy! Please verify your email to get started"
          : "Please verify your email address",
        message: isRegistration
          ? "Thank you for joining Educademy! To complete your registration and start learning, please verify your email address using the code below."
          : "Please use the verification code below to verify your email address.",
        code: otp,
        codeLabel: "Verification Code",
        expirationMinutes: expiresIn,
        actionButton: actionUrl ? "Verify Email" : null,
        actionUrl: actionUrl,
        features: isRegistration
          ? [
              {
                icon: "🎯",
      ...
      const mailOptions = {
        ...
        subject: isRegistration
          ? "Welcome to Educademy - Please Verify Your Email"
          : "Verify Your Email - Educademy",
        html: emailContent,
      };
      ...
      if (previewUrl) {
        console.log(`OTP verification email preview: ${previewUrl}`);
      }

      console.log(`OTP verification sent to ${email}`);
